...
namespace FolderSync
{
    ...
    {
        public DataGridViewCheckedListBoxColumn()
            : base(new DataGridViewCheckedListBoxCell())
        {
        }
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            {
                if (value != null &&
                    !value.GetType().IsAssignableFrom(typeof(DataGridViewCheckedListBoxCell)))
                {
    ...
    public class DataGridViewCheckedListBoxCell : DataGridViewCell
    {
        public DataGridViewCheckedListBoxCell()
            : base()
        {
            ...
            initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            DataGridViewCheckedListBoxEditingControl ctl =
                DataGridView.EditingControl as DataGridViewCheckedListBoxEditingControl;
    ...
    class DataGridViewCheckedListBoxEditingControl : CheckedListBox, IDataGridViewEditingControl
    {
